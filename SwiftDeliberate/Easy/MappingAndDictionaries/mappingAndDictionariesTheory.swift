 ...
 * **Концепция:** Идея ассоциативных массивов (словарей/маппинга) зародилась в 1960-х в языке LISP (автор Джон Маккарти).
 * **В Swift:** Стал доступен с первого релиза в 2014 (архитектор Крис Латтнер). Хэш-таблицы (основа `Dictionary`) в Swift были оптимизированы для максимальной скорости доступа за константное время $O(1)$.
